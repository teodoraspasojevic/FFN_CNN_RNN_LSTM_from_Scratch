...
class CrossEntropyLoss:
    ...
    def forward(self, prediction_tensor, label_tensor):
        ...
        # We calculate the sum of negative log of prediction value for the true class, plus e.
    ...
    def backward(self, label_tensor):
        ...
        """
        # We divide the true label with predicted probability.
        eps = np.finfo(float).eps
        previous_error_tensor = - label_tensor / (self.prediction_tensor + eps)
